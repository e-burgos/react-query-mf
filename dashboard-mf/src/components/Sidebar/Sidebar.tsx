            ...
            <ul className='md:flex-col md:min-w-full flex flex-col list-none'>
              ...
              <li className='items-center'>
                <Link
                  className={
                    'text-xs uppercase py-3 font-bold block ' +
                    (window.location.href.indexOf('/admin/otherpages') !== -1
                      ? 'text-lightBlue-500 hover:text-lightBlue-600'
                      : 'text-blueGray-700 hover:text-blueGray-500')
                  }
                  to='/admin/otherpages'>
                  <i
                    className={
                      'fab fa-react mr-2 text-sm ' +
                      (window.location.href.indexOf('/admin/otherpages') !== -1 ? 'opacity-75' : 'text-blueGray-300')
                    }></i>{' '}
                  Other MFs
                </Link>
              </li>
            ...
            <ul className='md:flex-col md:min-w-full flex flex-col list-none md:mb-4'>
              ...
              <li className='items-center'>
                <Link
                  className='text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block'
                  to='/landing/company'>
                  <i className='fas fa-user-circle text-blueGray-400 mr-2 text-sm'></i> Company Page
                </Link>
              </li>
            </ul>
